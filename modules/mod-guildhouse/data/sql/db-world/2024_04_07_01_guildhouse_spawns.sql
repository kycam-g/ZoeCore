...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
  ...
  (32, 184137, 16220.3, 16272, 12.9736, 4.45592, 'Caixa de Correio (Objeto)'),
  ...
  (45, 187293, 16230.5, 16283.5, 13.9061, 3, 'Cofre da Guilda (Objeto)'),
  (46, 28692, 16236.2, 16315.7, 20.8454, 4.64365, 'Suprimentos Comerciais'),
  (47, 28776, 16223.7, 16297.9, 20.8454, 6.17044, 'Vendedor de Tabardos'),
  (48, 19572, 16230.2, 16316.1, 20.8455, 4.64365, 'Vendedor de Comida e Bebida'),
  (49, 6491, 16319.937, 16242.404, 24.4747, 2.206830, 'Spirit Healer'),
  (50, 191028, 16255.5, 16304.9, 20.9785, 2.97516, 'Cadeira de Barbeiro (Objeto)'),
  (51, 29636, 16233.2, 16315.9, 20.8454, 4.64365, 'Vendedor de Reagentes'),
  (52, 29493, 16229.1, 16286.4, 13.176, 3.03831, 'Vendedor de Municao e Reparo'),
  (53, 28690, 16226.97, 16267.9, 13.15, 4.6533, 'Mestre de Estabulo'),
  (54, 9858, 16238.2, 16291.8, 22.9306, 1.55386, 'Leiloeiro Neutro'),
  (55, 2622, 16242.8, 16302.1, 13.176, 4.55570, 'Vendedor de Venenos');
