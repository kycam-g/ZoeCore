-- ZoeCore Anticheat V4 - SQL Locale Fix
-- Rode no banco world se a aplicação anterior falhou com:
-- ERROR 1265 (01000): Data truncated for column 'locale'
--
-- Motivo:
-- Algumas cores 3.3.5a não aceitam 'ptBR' na coluna module_string_locale.locale.
-- A tradução PT-BR agora fica no module_string default, sem usar module_string_locale.
